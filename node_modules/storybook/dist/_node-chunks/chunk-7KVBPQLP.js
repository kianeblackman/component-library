...
var getObject = /* @__PURE__ */ __name((detail) => typeof detail === "number" ? {
  top: detail,
  right: detail * 3,
  bottom: detail,
  left: detail * 3
...
var getBorderWidth = /* @__PURE__ */ __name((borderStyle) => borderStyle === NONE ? 0 : 2, "getBorderWidth");
var getBorderChars = /* @__PURE__ */ __name((borderStyle) => {
  const sides = [
    "topLeft",
    "topRight",
    "bottomRight",
...
var makeTitle = /* @__PURE__ */ __name((text, horizontal, alignment) => {
  let title = "";
...
var makeContentText = /* @__PURE__ */ __name((text, { padding, width, textAlignment, height }) => {
...
var sanitizeOptions = /* @__PURE__ */ __name((options) => {
...
var determineDimensions = /* @__PURE__ */ __name((text, options) => {
