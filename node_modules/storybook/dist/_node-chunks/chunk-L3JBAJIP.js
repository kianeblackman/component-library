...
__name(getArbitraryModuleIdentifier, "getArbitraryModuleIdentifier");
...
__name(getAutomockCode, "getAutomockCode");
function automockModule(code, mockType, parse, options = {}) {
  ...
  for (const _node of ast.body) {
    ...
    if (_node.type === "ExportNamedDeclaration") {
      ...
      __name(traversePattern2, "traversePattern");
      const node = _node;
...
__name(automockModule, "automockModule");
