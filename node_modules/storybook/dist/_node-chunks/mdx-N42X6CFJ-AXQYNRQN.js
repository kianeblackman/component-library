...
var SourceLocation = /* @__PURE__ */ __name(function SourceLocation2(p, start2, end) {
  this.start = start2;
  this.end = end;
...
RegExpValidationState.prototype.reset = /* @__PURE__ */ __name(function reset(start2, pattern, flags) {
...
var require_acorn_jsx = __commonJS({
  "node_modules/micromark-extension-mdxjs/node_modules/acorn-jsx/index.js"(exports, module) {
    ...
    function plugin(options, Parser22) {
      const acorn = Parser22.acorn || __require("acorn");
...
var require_extend = __commonJS({
  "node_modules/extend/index.js"(exports, module) {
    ...
    var isArray2 = /* @__PURE__ */ __name(function isArray22(arr) {
...
__name(resolveFileAndOptions, "resolveFileAndOptions");
...
__name(mdxExpressionFromMarkdown, "mdxExpressionFromMarkdown");
...
__name(mdxExpressionToMarkdown, "mdxExpressionToMarkdown");
function enterMdxFlowExpression(token) {
  this.enter({ type: "mdxFlowExpression", value: "" }, token);
  this.buffer();
}
__name(enterMdxFlowExpression, "enterMdxFlowExpression");
function enterMdxTextExpression(token) {
  this.enter({ type: "mdxTextExpression", value: "" }, token);
  this.buffer();
}
__name(enterMdxTextExpression, "enterMdxTextExpression");
...
__name(exitMdxExpression, "exitMdxExpression");
function exitMdxExpressionData(token) {
  this.config.enter.data.call(this, token);
  this.config.exit.data.call(this, token);
}
__name(exitMdxExpressionData, "exitMdxExpressionData");
function handleMdxExpression(node2) {
  const value = node2.value || "";
  return "{" + value + "}";
}
__name(handleMdxExpression, "handleMdxExpression");
...
function mdxJsxFromMarkdown() {
  ...
  __name(enterMdxJsxTag, "enterMdxJsxTag");
  ...
  __name(enterMdxJsxTagClosingMarker, "enterMdxJsxTagClosingMarker");
  ...
  __name(enterMdxJsxTagAnyAttribute, "enterMdxJsxTagAnyAttribute");
  ...
  __name(enterMdxJsxTagSelfClosingMarker, "enterMdxJsxTagSelfClosingMarker");
  function exitMdxJsxTagClosingMarker() {
    const tag = this.data.mdxJsxTag;
    ok(tag, "expected `mdxJsxTag`");
    tag.close = true;
  }
  __name(exitMdxJsxTagClosingMarker, "exitMdxJsxTagClosingMarker");
  function exitMdxJsxTagNamePrimary(token) {
    const tag = this.data.mdxJsxTag;
    ok(tag, "expected `mdxJsxTag`");
    tag.name = this.sliceSerialize(token);
  }
  __name(exitMdxJsxTagNamePrimary, "exitMdxJsxTagNamePrimary");
  function exitMdxJsxTagNameMember(token) {
    const tag = this.data.mdxJsxTag;
    ok(tag, "expected `mdxJsxTag`");
    tag.name += "." + this.sliceSerialize(token);
  }
  __name(exitMdxJsxTagNameMember, "exitMdxJsxTagNameMember");
  function exitMdxJsxTagNameLocal(token) {
    const tag = this.data.mdxJsxTag;
    ok(tag, "expected `mdxJsxTag`");
    tag.name += ":" + this.sliceSerialize(token);
  }
  __name(exitMdxJsxTagNameLocal, "exitMdxJsxTagNameLocal");
  ...
  __name(enterMdxJsxTagAttribute, "enterMdxJsxTagAttribute");
  ...
  __name(enterMdxJsxTagExpressionAttribute, "enterMdxJsxTagExpressionAttribute");
  ...
  __name(exitMdxJsxTagExpressionAttribute, "exitMdxJsxTagExpressionAttribute");
  ...
  __name(exitMdxJsxTagAttributeNamePrimary, "exitMdxJsxTagAttributeNamePrimary");
  ...
  __name(exitMdxJsxTagAttributeNameLocal, "exitMdxJsxTagAttributeNameLocal");
  ...
  __name(exitMdxJsxTagAttributeValueLiteral, "exitMdxJsxTagAttributeValueLiteral");
  ...
  __name(exitMdxJsxTagAttributeValueExpression, "exitMdxJsxTagAttributeValueExpression");
  function exitMdxJsxTagSelfClosingMarker() {
    const tag = this.data.mdxJsxTag;
    ok(tag, "expected `mdxJsxTag`");
    tag.selfClosing = true;
  }
  __name(exitMdxJsxTagSelfClosingMarker, "exitMdxJsxTagSelfClosingMarker");
  ...
  __name(exitMdxJsxTag, "exitMdxJsxTag");
  ...
  __name(onErrorRightIsTag, "onErrorRightIsTag");
  ...
  __name(onErrorLeftIsTag, "onErrorLeftIsTag");
  function serializeAbbreviatedTag(tag) {
    return "<" + (tag.close ? "/" : "") + (tag.name || "") + ">";
  }
  __name(serializeAbbreviatedTag, "serializeAbbreviatedTag");
}
__name(mdxJsxFromMarkdown, "mdxJsxFromMarkdown");
function mdxJsxToMarkdown(options) {
  ...
  __name(mdxElement, "mdxElement");
}
__name(mdxJsxToMarkdown, "mdxJsxToMarkdown");
...
__name(peekElement, "peekElement");
...
__name(mdxjsEsmFromMarkdown, "mdxjsEsmFromMarkdown");
function mdxjsEsmToMarkdown() {
  return { handlers: { mdxjsEsm: handleMdxjsEsm } };
}
__name(mdxjsEsmToMarkdown, "mdxjsEsmToMarkdown");
function enterMdxjsEsm(token) {
  this.enter({ type: "mdxjsEsm", value: "" }, token);
  this.buffer();
}
__name(enterMdxjsEsm, "enterMdxjsEsm");
...
__name(exitMdxjsEsm, "exitMdxjsEsm");
function exitMdxjsEsmData(token) {
  this.config.enter.data.call(this, token);
  this.config.exit.data.call(this, token);
}
__name(exitMdxjsEsmData, "exitMdxjsEsmData");
function handleMdxjsEsm(node2) {
  return node2.value || "";
}
__name(handleMdxjsEsm, "handleMdxjsEsm");
...
__name(mdxFromMarkdown, "mdxFromMarkdown");
...
__name(mdxToMarkdown, "mdxToMarkdown");
...
__name(unicodePunctuation, "unicodePunctuation");
...
function eventsToAcorn(events, options) {
  ...
  __name(fixPosition, "fixPosition");
  ...
  __name(parseOffsetToUnistPoint, "parseOffsetToUnistPoint");
}
__name(eventsToAcorn, "eventsToAcorn");
...
__name(relativeToPoint, "relativeToPoint");
...
__name(positionFromEstree, "positionFromEstree");
...
__name(pointOrUndefined, "pointOrUndefined");
...
function factoryMdxExpression(effects, ok3, type, markerType, chunkType, acorn, acornOptions, addResult, spread, allowEmpty, allowLazy) {
  ...
  __name(eolAfter, "eolAfter");
}
__name(factoryMdxExpression, "factoryMdxExpression");
...
__name(mdxExpressionParse, "mdxExpressionParse");
...
function mdxExpression(options) {
  ...
  __name(tokenizeFlowExpression, "tokenizeFlowExpression");
  ...
  __name(tokenizeTextExpression, "tokenizeTextExpression");
}
...
function factoryTag(effects, ok3, nok, acorn, acornOptions, addResult, allowLazy, tagType, tagMarkerType, tagClosingMarkerType, tagSelfClosingMarker, tagNameType, tagNamePrimaryType, tagNameMemberMarkerType, tagNameMemberType, tagNamePrefixMarkerType, tagNameLocalType, tagExpressionAttributeType, tagExpressionAttributeMarkerType, tagExpressionAttributeValueType, tagAttributeType, tagAttributeNameType, tagAttributeNamePrimaryType, tagAttributeNamePrefixMarkerType, tagAttributeNameLocalType, tagAttributeInitializerMarkerType, tagAttributeValueLiteralType, tagAttributeValueLiteralMarkerType, tagAttributeValueLiteralValueType, tagAttributeValueExpressionType, tagAttributeValueExpressionMarkerType, tagAttributeValueExpressionValueType) {
  ...
  __name(closingTagNameBefore, "closingTagNameBefore");
  ...
  __name(primaryName, "primaryName");
  ...
  __name(primaryNameAfter, "primaryNameAfter");
  ...
  __name(memberNameBefore, "memberNameBefore");
  ...
  __name(memberNameAfter, "memberNameAfter");
  ...
  __name(localNameBefore, "localNameBefore");
  ...
  __name(localNameAfter, "localNameAfter");
  ...
  __name(attributeBefore, "attributeBefore");
  function attributeExpressionAfter(code2) {
    returnState = attributeBefore;
    return esWhitespaceStart(code2);
  }
  __name(attributeExpressionAfter, "attributeExpressionAfter");
  ...
  __name(attributePrimaryName, "attributePrimaryName");
  ...
  __name(attributePrimaryNameAfter, "attributePrimaryNameAfter");
  ...
  __name(attributeLocalNameBefore, "attributeLocalNameBefore");
  ...
  __name(attributeLocalName, "attributeLocalName");
  ...
  __name(attributeLocalNameAfter, "attributeLocalNameAfter");
  ...
  __name(attributeValueBefore, "attributeValueBefore");
  function attributeValueExpressionAfter(code2) {
    effects.exit(tagAttributeType);
    returnState = attributeBefore;
    return esWhitespaceStart(code2);
  }
  __name(attributeValueExpressionAfter, "attributeValueExpressionAfter");
  ...
  __name(attributeValueQuotedStart, "attributeValueQuotedStart");
  ...
  __name(attributeValueQuoted, "attributeValueQuoted");
  ...
  __name(esWhitespaceStart, "esWhitespaceStart");
  ...
  __name(esWhitespaceInside, "esWhitespaceInside");
  ...
  __name(esWhitespaceEolAfter, "esWhitespaceEolAfter");
...
function jsxText(acorn, options) {
  ...
  __name(tokenizeJsxText, "tokenizeJsxText");
}
...
function jsxFlow(acorn, options) {
  ...
  __name(tokenizeJsxFlow, "tokenizeJsxFlow");
}
__name(jsxFlow, "jsxFlow");
...
function mdxjsEsm(options) {
  ...
  __name(tokenizeExportImport, "tokenizeExportImport");
}
...
__name(tokenizeNextBlank, "tokenizeNextBlank");
...
function createTokenizer(parser, initialize, from) {
  ...
  function now() {
    const { line, column, offset: offset2, _index, _bufferIndex } = point3;
    return {
      line,
      column,
      offset: offset2,
...
__name(serializeChunks2, "serializeChunks2");
...
__export(constructs_exports, {
  ...
  document: /* @__PURE__ */ __name(() => document2, "document"),
...
function compiler(options) {
  ...
  function onexitcharacterreferencevalue(token) {
    const data22 = this.sliceSerialize(token);
    ...
    if (type) {
      ...
      const result = decodeNamedCharacterReference(data22);
      value = result;
    }
    const tail = this.stack.pop();
    tail.value += value;
...
var EMPTY = "";
var { toString: toString22 } = {};
var { keys } = Object;
var typeOf = /* @__PURE__ */ __name((value) => {
  const type = typeof value;
  if (type !== "object" || !value)
    return [PRIMITIVE, type];
  const asString = toString22.call(value).slice(8, -1);
  switch (asString) {
    case "Array":
      return [ARRAY, EMPTY];
    case "Object":
...
function toResult2(value) {
  ...
  return value === null || value === void 0 ? empty22 : [value];
}
__name(toResult2, "toResult2");
...
__name(looksLikeAVFile2, "looksLikeAVFile2");
...
var WalkerBase = class {
  ...
  constructor() {
    ...
    this.context = {
      ...
      replace: /* @__PURE__ */ __name((node2) => this.replacement = node2, "replace")
    };
  }
  /**
...
__name(is_reference, "is_reference");
...
__name(add_reference, "add_reference");
var Scope3 = class {
  static {
    __name(this, "Scope");
  }
  ...
  add_declaration(node2) {
    if (node2.type === "VariableDeclaration") {
      if (node2.kind === "var" && this.block && this.parent) {
        ...
        const handle_declarator = /* @__PURE__ */ __name((declarator) => {
...
__name(extract_names, "extract_names");
function extract_identifiers(param, nodes = []) {
  switch (param.type) {
    ...
    case "MemberExpression":
      ...
      break;
    case "ObjectPattern":
      const handle_prop = /* @__PURE__ */ __name((prop) => {
      ...
      break;
    case "ArrayPattern":
      const handle_element = /* @__PURE__ */ __name((element) => {
        if (element)
...
__name(extract_identifiers, "extract_identifiers");
...
__name(declarationToExpression, "declarationToExpression");
...
__name(specifiersToDeclarations, "specifiersToDeclarations");
...
__name(toIdOrMemberExpression, "toIdOrMemberExpression");
...
__name(toJsxIdOrMemberExpression, "toJsxIdOrMemberExpression");
function recmaDocument(options) {
  ...
  __name(createMdxContent, "createMdxContent");
}
__name(recmaDocument, "recmaDocument");
...
__name(resolveDynamicMdxSpecifier, "resolveDynamicMdxSpecifier");
...
__name(createImportMetaUrlVariable, "createImportMetaUrlVariable");
    ...
    leave(node2) {
      ...
      while (++index2 < node2.children.length) {
        ...
        if (child.type === "JSXExpressionContainer") {
          ...
          if (value) {
            const text4 = { type: "Literal", value };
            create2(child, text4);
            children.push(text4);
          }
        } else {
...
__name(toMemberExpression, "toMemberExpression");
...
__name(recmaJsxBuild, "recmaJsxBuild");
...
__name(toBinaryAddition, "toBinaryAddition");
...
__name(recmaJsxRewrite, "recmaJsxRewrite");
...
__name(expressionNeedsParenthesis, "expressionNeedsParenthesis");
...
__name(formatExpression, "formatExpression");
...
function formatComments(state, comments, indent2, lineEnd) {
  ...
  for (let i = 0; i < length; i++) {
    ...
    if (comment.type[0] === "L") {
      ...
      state.write("/*");
      reindent(state, comment.value, indent2, lineEnd);
      state.write("*/" + lineEnd);
    }
  }
}
__name(formatComments, "formatComments");
...
__name(hasCallExpression, "hasCallExpression");
...
__name(formatVariableDeclaration, "formatVariableDeclaration");
var ForInStatement;
...
var GENERATOR = {
  ...
  */
  ...
  BlockStatement: BlockStatement = /* @__PURE__ */ __name(function(node2, state) {
    const indent2 = state.indent.repeat(state.indentLevel++);
    const { lineEnd, writeComments } = state;
  ...
  ForInStatement: ForInStatement = /* @__PURE__ */ __name(function(node2, state) {
  ...
  FunctionDeclaration: FunctionDeclaration = /* @__PURE__ */ __name(function(node2, state) {
    state.write(
  ...
  RestElement: RestElement = /* @__PURE__ */ __name(function(node2, state) {
    state.write("...");
    this[node2.argument.type](node2.argument, state);
  }, "RestElement"),
  ...
  ArrayExpression: ArrayExpression = /* @__PURE__ */ __name(function(node2, state) {
    state.write("[");
  ...
  BinaryExpression: BinaryExpression = /* @__PURE__ */ __name(function(node2, state) {
...
function toJs(tree, options) {
  const { SourceMapGenerator, filePath, handlers: handlers2 } = options || emptyOptions4;
...
__name(jsxText2, "jsxText2");
function encodeJsx(value) {
  return value.replace(/&(?=[#a-z])/gi, "&amp;");
}
__name(encodeJsx, "encodeJsx");
function replaceJsxChar($0) {
  return $0 === "<" ? "&lt;" : $0 === ">" ? "&gt;" : $0 === "{" ? "&#123;" : "&#125;";
}
__name(replaceJsxChar, "replaceJsxChar");
function recmaStringify(options) {
  ...
  __name(compiler2, "compiler2");
}
__name(recmaStringify, "recmaStringify");
function rehypeRecma(options) {
  return function(tree) {
    return toEstree(tree, options);
  };
}
__name(rehypeRecma, "rehypeRecma");
...
__name(rehypeRemoveRaw, "rehypeRemoveRaw");
var js = /\s+/g;
var html2 = /[\t\n\v\f\r ]+/g;
...
__name(replaceLineEnding, "replaceLineEnding");
function replaceSpace() {
  return " ";
}
__name(replaceSpace, "replaceSpace");
function trimFactory(replace) {
  ...
  __name(dropOrReplace, "dropOrReplace");
}
__name(trimFactory, "trimFactory");
...
__name(remarkMarkAndUnravel, "remarkMarkAndUnravel");
var nodeTypes = (
  /** @type {const} */
  [
    "mdxFlowExpression",
...
__name(compileSync, "compileSync");
...
__name(resolveEvaluateOptions, "resolveEvaluateOptions");
