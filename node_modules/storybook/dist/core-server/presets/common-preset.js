...
var viteFinal = /* @__PURE__ */ __name(async (existing, options) => {
  ...
  const { viteInjectMockerRuntime } = await import("../../_node-chunks/plugin-LW72M2ZP.js");
  const { viteMockPlugin } = await import("../../_node-chunks/plugin-APERPUBY.js");
  const coreOptions = await options.presets.apply("core");
  return {
    ...existing,
    plugins: [
...
var webpackFinal = /* @__PURE__ */ __name(async (config, options) => {
  ...
  const { WebpackMockPlugin } = await import("../../_node-chunks/webpack-mock-plugin-OO2UQIKX.js");
  const { WebpackInjectMockerRuntimePlugin } = await import("../../_node-chunks/webpack-inject-mocker-runtime-plugin-ERTFMWK2.js");
