...
import {
  ...
  unsupportedTemplate,
  writeFileAsJson
} from "../_node-chunks/chunk-RF57GVT2.js";
import {
  boxen
} from "../_node-chunks/chunk-7KVBPQLP.js";
import "../_node-chunks/chunk-TNNFJ72G.js";
import {
  Settings,
  _clearGlobalSettings,
  globalSettings
} from "../_node-chunks/chunk-AOVN24BT.js";
import {
  up2 as up
} from "../_node-chunks/chunk-ZJVEXDYR.js";
import "../_node-chunks/chunk-35SLFIQV.js";
import "../_node-chunks/chunk-7N53RHGS.js";
import "../_node-chunks/chunk-LMQEOO5W.js";
import {
  require_prompts
} from "../_node-chunks/chunk-KCF2Q4OQ.js";
import {
  require_dist
...
import {
  ...
  traverse,
  types
} from "../_node-chunks/chunk-SM76KKDZ.js";
import "../_node-chunks/chunk-3RGO4AAD.js";
import "../_node-chunks/chunk-R33VBU5H.js";
import {
  require_picocolors
...
var require_parse = __commonJS({
  "../node_modules/comment-json/src/parse.js"(exports, module) {
    ...
    var is = /* @__PURE__ */ __name((t) => type() === t, "is");
...
function unwrapTSExpression(expr) {
  ...
  if (types.isTSAsExpression(expr) || types.isTSSatisfiesExpression(expr)) {
    return unwrapTSExpression(expr.expression);
  }
  return expr;
}
__name(unwrapTSExpression, "unwrapTSExpression");
var configureFlatConfig = /* @__PURE__ */ __name(async (code) => {
  ...
  traverse(ast, {
    ...
    ExportDefaultDeclaration(path) {
      ...
      if (types.isArrayExpression(eslintConfigExpression)) {
        eslintConfigExpression.elements.push(types.spreadElement(storybookConfig));
      }
      if (types.isCallExpression(eslintConfigExpression) && types.isMemberExpression(eslintConfigExpression.callee) && tsEslintLocalName && types.isIdentifier(eslintConfigExpression.callee.object, { name: tsEslintLocalName }) && types.isIdentifier(eslintConfigExpression.callee.property, { name: "config" })) {
...
async function extractEslintInfo(packageManager) {
  let unsupportedExtension = void 0;
...
__name(extractEslintInfo, "extractEslintInfo");
var normalizeExtends = /* @__PURE__ */ __name((existingExtends) => {
  if (!existingExtends) {
    return [];
  }
...
__name(configureEslintPlugin, "configureEslintPlugin");
